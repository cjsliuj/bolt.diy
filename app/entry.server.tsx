...
export default async function handleRequest(
  ...
  // Combine the Remix-provided context with our application-specific load context.
  // appLoadContext will contain serverEnv if getLoadContext is set up correctly.
